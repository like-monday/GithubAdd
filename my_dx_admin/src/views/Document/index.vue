  ...
  <div id="Document">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="tmForm.id" type="primary" @click="addOrUpdateDocument"
          >修 改</el-button
        >
...
export default {
  ...
  methods: {
    ...
    //获取信息列表
    getDocument () {
      this.search_form.type = this.Modulevalue
      this.loading = true
      reqDocument(this.search_form).then((result) => {
        // console.log("修改后的获取信息列表", result);
        if (result.data.total > 0 && result.data.data.length < 1) {
